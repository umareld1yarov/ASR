...
class ActivityEntry {
  ...
  /// Пути к прикреплённым фото (до 4 штук) — файлы хранятся в папке
  /// приложения, здесь только относительные пути к ним.
  List<String>? photoPaths;

  /// Фактическая заметка о сессии (подходы, страница, детали) — не оценка,
  /// просто факт. Доступна для любой категории, заполняется в любой момент.
  String? note;
}
